...
function KethoDoc:GetWidgetObjects_v2()
	local t = {
		...
		ArchaeologyDigSiteFrame = {TryCreateFrame_v2("ArchaeologyDigSiteFrame"), {"FrameAPIArchaeologyDigSiteFrame"}},
...
function KethoDoc:GetScriptObjectDocs_v2()
	local t = {}
...
function KethoDoc:GetWidgetTests_v2()
	local t = {
...
function KethoDoc:WidgetTest_v2()
	APIDocumentation_LoadUI()
	local widget_objects = self:GetWidgetObjects_v2()
	local widget_docs = self:GetScriptObjectDocs_v2()
	local widget_tests = self:GetWidgetTests_v2()
