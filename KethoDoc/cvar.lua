...
m.cvar_cache = {
	var = {
		...
		["AdvFlying"] = {"1", 4, false, false, "Enables advanced flying animations"},
		["AdvFlyingClampCameraAngles"] = {"1", 4, false, false, "Enables camera clamping when gliding"},
		["AdvFlyingDynamicFOVEnabled"] = {"1", 4, false, false, "Enables adjustment of camera field of view based on gliding speed"},
		["AdvFlyingFoVBlendCurvePower"] = {"3.0", 4, false, false, "Higher values bias FOV adjustment to occur most at higher speeds"},
		["AdvFlyingFoVBlendInterpSpeed"] = {"3.0", 4, false, false, "Adjusts the speed at which the gliding FoV animates"},
		["AdvFlyingFoVBlendMaxOffset"] = {"66.0", 4, false, false, "The maximum amount that gliding should increase FoV degrees)"},
		["AdvFlyingFoVBlendMaxVelocity"] = {"80.0", 4, false, false, "The maximum velocity while gliding at which FoV reaches max offset"},
		["AdvFlyingFoVBlendMinVelocity"] = {"40.0", 4, false, false, "The minimum velocity while gliding at which FoV begins increasing"},
		["AdvFlyingScreenEffectsEnabled"] = {"0", 4, false, false, "Enables full screen effects for gliding"},
		["AdvFlyingStartDiveAngle"] = {"-1.05", 4, false, false, "Start dive angle"},
		["AdvFlyingStopDiveAngle"] = {"-0.95", 4, false, false, "Stop dive angle"},
		...
		["EmpowerMinHoldStagePercent"] = {"0.500000", 4, true, false, "Sets a percentage of the first empower stage [0.0,1.0]. Before this point, the spell will be auto-held. After it, releases will be accepted."},
		...
		["EmpowerTapControlsReleaseThreshold"] = {"500", 4, true, false, "Sets the time in milliseconds after which release/re-hold requests will be registered for press-and-tap empowers. Begins when the cast is sent from the client."},
		...
		["GxAllowCachelessShaderMode"] = {"1", 1, false, false, "CPU memory saving mode, if supported by backend. When enabled, shaders are fetched from disk as needed instead of being kept resident. This mode may slightly increase the time objects take to appear the first time they are encountered. Computers without solid state drives may want to disable this feature"},
		...
		["minimapTrackedInfov2"] = {"", 4, nil, nil, "Stores the minimap tracking that was active last session."},
		["minimapTrackedInfov3"] = {"1007343", 4, false, true, "Stores the minimap tracking that was active last session."},
		...
		["professionGearSlotsExampleShown"] = {"0", 4, false, true, "If the profession gear slots example has been shown"},
		...
		["SoftTargetEnemy"] = {"0", 4, false, false, "Sets when enemy soft targeting should be enabled. 0=off, 1=gamepad, 2=KBM, 3=always"},
		["SoftTargetEnemyRange"] = {"40", 4, false, false, ""},
		["SoftTargetForce"] = {"1", 4, false, false, "Auto-set target to match soft target. 1 = for enemies, 2 = for friends"},
		["SoftTargetFriend"] = {"0", 4, false, false, "Sets when friend soft targeting should be enabled. 0=off, 1=gamepad, 2=KBM, 3=always"},
		["SoftTargetFriendRange"] = {"40", 4, false, false, ""},
		["SoftTargetIconEnemy"] = {"0", 4, false, false, "Show icon for soft enemy target"},
		["SoftTargetIconFriend"] = {"0", 4, false, false, "Show icon for soft friend target"},
		["SoftTargetIconGameObject"] = {"0", 4, false, false, "Show icon for sot interact game objects (interactable objects you cannot normally target)"},
		["SoftTargetIconInteract"] = {"1", 4, false, false, "Show icon for soft interact target"},
		["SoftTargetInteract"] = {"0", 4, false, false, "Sets when soft interact should be enabled. 0=off, 1=gamepad, 2=KBM, 3=always"},
		["SoftTargetInteractArc"] = {"0", 4, false, false, "0 = No yaw arc allowance, must be directly in front. 1 = Must be in front yaw arc. 2 = Can be anywhere in targeting area."},
		["SoftTargetInteractRange"] = {"10", 4, false, false, ""},
		["SoftTargetInteractRangeIsHard"] = {"0", 4, false, false, "Sets if it should be a hard range cutoff, even for something you can interact with right now."},
		["SoftTargetLowPriorityIcons"] = {"0", 4, false, false, "Show interact icons even when there is other visual indicators, such as quest or loot effects"},
		...
		["SoftTargetNameplateEnemy"] = {"1", 4, false, false, "Always show nameplates for soft enemy target"},
		["SoftTargetNameplateFriend"] = {"0", 4, false, false, "Always show nameplates for soft friend target"},
		["SoftTargetNameplateInteract"] = {"0", 4, false, false, "Always show nameplates for soft interact target"},
		["SoftTargetNameplateSize"] = {"19", 4, false, false, "Size of soft target icon on nameplate (0 to disable)"},
		["SoftTargetTooltipDurationMs"] = {"2000", 4, false, false, ""},
		["SoftTargetTooltipEnemy"] = {"0", 4, false, false, ""},
		["SoftTargetTooltipFriend"] = {"0", 4, false, false, ""},
		["SoftTargetTooltipInteract"] = {"0", 4, false, false, ""},
		["SoftTargetTooltipLocked"] = {"0", 4, false, false, ""},
		...
		["SoftTargetWorldtextFarDist"] = {"40", 4, false, false, ""},
		["SoftTargetWorldtextNearDist"] = {"4", 4, false, false, ""},
		["SoftTargetWorldtextNearScale"] = {"1", 4, false, false, ""},
		["SoftTargetWorldtextSize"] = {"32", 4, false, false, ""},
		...
		["TargetAutoEnemy"] = {"1", 4, false, true, "Auto-Target victims of your single target harmful spells"},
		...
		["useCompactPartyFrames"] = {"", 4, nil, nil, "Use the new raid frames for parties"},
