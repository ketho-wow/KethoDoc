...
m.cvar_cache = {
	var = {
		...
		["acknowledgedArrowCallouts"] = {"0", 4, false, true, "Bit field of Looking for guild player settings"},
		...
		["dnMTUpdate"] = {"1", 1, false, false, "Update Daynight in parralel."},
		...
		["EnableAirlockLogging"] = {"0", 4, false, false, "If 1, enables airlock logging, which will print out the various steps as they happen so that timing can be done."},
		...
		["excludedCensorSources"] = {"1", 4, true, false, "Inappropriate message source exemptions. 0 = Exempt nobody, 1 = Exempt Friends, 3 = Exempt Friends and Guildmates, 255 = Exempt All"},
		...
		["friendInvitesCollapsed_WowLabs"] = {"0", 4, false, false, "The info for pending invites has been shown"},
		...
		["frontendMatchingModes_WowLabs"] = {"1", 4, false, false, "0=All,1=DuoOnly,2=TrioOnly,3=DuoAndTrio"},
		...
		["GxFrameEndMode"] = {"0", 1, false, false, "Allow GxFrameEnd to overlap next frame (0=Disabled, 1=Safe, 2=Experimental)"},
		...
		["locateViewerMaxJobs"] = {"32", 1, false, false, "Maximum job threads for LocateViewer"},
		...
		["minimapTrackedInfov2"] = {"", 5, nil, nil, ""},
		...
		["nameplateGameObjectMaxDistance"] = {"30", 1, false, true, "The max distance to show player nameplates for game objects"},
		...
		["nameplateShowOnlyNames"] = {"0", 4, false, false, "Whether to hide the nameplate bars"},
		...
		["partyInvitesCollapsed_WowLabs"] = {"0", 4, false, false, "The info for pending invites has been shown"},
		...
		["pendingInviteInfoShown_WowLabs"] = {"0", 4, false, false, "The info for pending invites has been shown"},
		...
		["RAIDshadowBlendCascades"] = {"0", 1, false, false, "Blend between shadow cascades (0/1)"},
		...
		["shadowBlendCascades"] = {"0", 1, false, false, "Blend between shadow cascades (0/1)"},
		...
		["vrsValar"] = {"0", 1, false, false, "Generate a shading rate mask based on velocity and luminance. Requires VRS Tier 2."},
		["vrsValarEnvLuma"] = {"0.05", 1, false, false, "Env. Luma for VALAR"},
		["vrsValarK"] = {"2.13", 1, false, false, "Quarter Rate Sensitivity (K) for VALAR"},
		["vrsValarSensitivityThreshold"] = {"0.31", 1, false, false, "Sensitivity Threshold for VALAR"},
		["vrsValarUseAsyncCompute"] = {"0", 1, false, false, "Use async compute for VALAR"},
		["vrsValarUseMotionVectors"] = {"0", 1, false, false, "Use motion vectors for VALAR"},
		["vrsValarUseWeberFechner"] = {"0", 1, false, false, "Use Weber-Fechner Algo for VALAR"},
		["vrsValarWeberFechnerConstant"] = {"1.0", 1, false, false, "Weber-Fechner Constant for VALAR"},
		...
		["WalkableSurfacesValidationLog"] = {"0", 5, false, false, ""},
		...
		["worldIntersectMaxJobs"] = {"32", 1, false, false, "Maximum job threads for culling"},
		...
		["wowLabsClosedTutorials"] = {"", 4, false, true, "Bitfield for which help frames have been acknowledged by the user, specifically for WoW Labs"},
