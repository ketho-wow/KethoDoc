...
function KethoDoc:LoadLodAddons()
	for _, addon in pairs(self.LoadOnDemand[self.branch]) do
		(UIParentLoadAddOn or LoadAddOnWithErrorHandling)(addon)
	end
end
...
KethoDoc.LoadOnDemand.mainline = {
	...
	"Blizzard_BattlefieldMap_Classic",
	"Blizzard_BattlefieldMap_Mainline",
	...
	"Blizzard_CombatText",
	"Blizzard_Commentator_Classic",
	"Blizzard_Commentator_Mainline",
	...
	"Blizzard_DeathRecap",
	"Blizzard_DeathRecap_Classic",
	"Blizzard_DebugTools",
	"Blizzard_DelvesDifficultyPicker",
	"Blizzard_Dispatcher",
	"Blizzard_EncounterJournal_Classic",
	"Blizzard_EncounterJournal_Mainline",
	"Blizzard_EncounterJournal_Mists",
	"Blizzard_EventTrace",
	"Blizzard_ExpansionTrial_Classic",
	"Blizzard_ExpansionTrial_Mainline",
	"Blizzard_FlightMap",
	...
	"Blizzard_RaidUI_Classic",
	"Blizzard_RaidUI_Mainline",
	...
	"Blizzard_TrainerUI_Classic",
	"Blizzard_TrainerUI_Mainline",
